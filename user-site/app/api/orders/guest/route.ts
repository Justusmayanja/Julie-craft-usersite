      ...
      getAdminEmails().then(async (adminEmails) => {
        ...
        const emailPromises = adminEmails.map(adminEmail =>
          sendNewOrderNotificationEmail(
            ...
            console.error(`[Guest Orders API] Error sending email to ${adminEmail}:`, err)
        ...
        console.log(`[Guest Orders API] Sent new order notifications to ${adminEmails.length} admin user(s)`)
      }).catch(err => {
        console.error('[Guest Orders API] Error getting admin emails:', err)
